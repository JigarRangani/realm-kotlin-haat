...
val realmWrapperJvm: Task = tasks.create("realmWrapperJvm") {
    doLast {
        ...
        exec {
            workingDir(".")
            commandLine("/opt/homebrew/bin/swig", "-java", "-c++", "-package", "io.realm.kotlin.internal.interop", "-I$projectDir/../external/core/src", "-o", "$generatedSourceRoot/jni/realmc.cpp", "-outdir", "$generatedSourceRoot/java/io/realm/kotlin/internal/interop", "realm.i")
        }
    }
